...
const PointerOverlay = ({ stack, heap, globals, containerRef, theme = 'dark' }: PointerOverlayProps) => {
  ...
  useEffect(() => {
    ...
    scrollContainers.forEach(c => c.addEventListener('scroll', updateConnections));
    
    return () => {
      cancelAnimationFrame(frameId);
      window.removeEventListener('resize', updateConnections);
      scrollContainers.forEach(c => c.removeEventListener('scroll', updateConnections));
    };
  }, [stack, heap, globals, containerRef]);
